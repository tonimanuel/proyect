...
-- Tiempo de generación: 08-05-2022 a las 20:11:05
...
CREATE TABLE `plataforma` (
  ...
  `Imagen` varchar(2050) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Imagen de la plataforma',
  `Logo` varchar(2050) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Logo de la consola'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
...
CREATE TABLE `usuario` (
  `idUsuario` int NOT NULL,
  `Usuario` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'El usuario debe ser ?nico en la Base de Datos. Adem?s debe tener una longitud m?nima de 6 caracteres.',
  `Password` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'La contrase?a no puede ser nula.\nTiene que tener una longitud m?nima de 8 caracteres, contener n?meros y alg?n car?cter especial de la siguiente lista (!,@,#,$,%,&,?,?,*,?)',
  `Nombre` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Apellido1` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Apellido2` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `Telefono` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Se comprobar? que solo puedan ser tel?fonos nacionales',
  `Email` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Se comprobar? que es un email v?lido',
  `CP` varchar(5) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Provincia` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Se comprobar? que la provincia introducida concuerda con el CP introducido',
  `ComunidadAutonoma` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Se comprobar? que la provincia seleccionada pertenece a la comunidad aut?noma correspondiente',
  `Rol` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `videojuego` (
  ...
  `Compania` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Publicacion` date NOT NULL,
  `Descripcion` longtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `Imagen` varchar(2050) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Url de la imagen de la car?tula del juego',
...
--
ALTER TABLE `comentarioplataforma`
  MODIFY `idComentario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `plataforma`
  MODIFY `idPlataforma` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `videojuego`
  MODIFY `idVideojuego` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
